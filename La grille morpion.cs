...
namespace Tp_Morpion_Camil_BOUACIDA
{
    internal class GrilleMorpion
    {
        ...
        public void deposerJeton(int ligne, int colonne, int id)
        {
            ...
            {
                Console.WriteLine("impossible ! Cette case n'est pas libre");
                Console.WriteLine("Saisir nouvelle ligne (0 - 2)");
                ligne = Convert.ToInt32(Console.ReadLine());
                Console.WriteLine("Saisir nouvelle colonne (0 - 2)");
